...
describe('<NavigationBar />', function () {
  ...
  it('should not render an NavigationBar with a close button in the OffsetNav when menuClose is true and noOverlay is false', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _lib.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { menuClose: true }))
    ));
  ...
  it('should pass a bgColor to the OffsetNav props', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _lib.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { offsetNav: { bgColor: 'primary' } }))
    ));
    expect(renderedComponent.find('OffsetNavSlide').props().bgColor).toEqual('primary');
  });
  it('should pass a top to the OffsetNav props', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _lib.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { offsetNav: { top: '50px' } }))
    ));
    expect(renderedComponent.find('OffsetNavSlide').props().top).toEqual('50px');
  });
  it('should pass a right to the OffsetNav props', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _lib.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { offsetNav: { right: true } }))
    ));
    expect(renderedComponent.find('OffsetNavSlide').props().right).toBe(true);
  });
  it('should pass a push to the OffsetNav props and set it ot OffsetNavPush', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _lib.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { offsetNav: { push: true } }))
    ));
    expect(renderedComponent.find('OffsetNavPush').props().push).toBe(true);
  });
  it('should pass a string to show to the OffsetNav props', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _lib.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { offsetNav: { show: 'md' } }))
    ));
