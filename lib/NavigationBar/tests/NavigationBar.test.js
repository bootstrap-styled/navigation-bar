...
describe('<NavigationBar />', function () {
  ...
  it('should render an NavigationBar placed below the Header', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _BootstrapProvider2.default,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { belowHeader: true }))
    ));
