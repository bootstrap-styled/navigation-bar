...
describe('<NavigationBar />', function () {
  ...
  it('should pass a show to the OffsetNav props', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      _bootstrapStyled.BootstrapProvider,
      { theme: theme },
      _react2.default.createElement(_NavigationBar2.default, Object.assign(props, { offsetNav: { show: false } }))
    ));
    expect(renderedComponent.find('OffsetNavSlide').props().show).toBe(true);
  });
