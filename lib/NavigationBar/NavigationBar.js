...
var NavigationBar = (0, _styledComponents2.default)(NavigationBarUnstyled).withConfig({
  ...
  return '\n    z-index:  ' + (0, _bootstrapStyledMixins.ifElse)(props.offsetNav.top, 'calc(' + props.theme.navigationBar['$zindex-overlay'] + ' + 15)', 'calc(' + props.theme.navigationBar['$zindex-overlay'] + ' - 10)') + ';\n    &.fixed-header-' + props.fixed + ' {\n      position: fixed;\n      ' + props.fixed + ': 0;\n    }\n  ';
});
